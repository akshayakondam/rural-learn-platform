  ...
  useEffect(() => {
    const initVideo = async () => {
      ...
      if (cached) {
        ...
        // Not in cache, try to download (only works for direct links)
        // In this demo, if it fails, we fallback to the original URL
        try {
          // We don't automatically cache everything to avoid blocking UI
